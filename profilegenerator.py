...
# Open images
    ...
    # Create a new rounded mask (for the border effect)
    ...
    # Paste the rounded profile pic in the center
    ...
    # Paste the final bordered profile pic onto the banner
    ...
    # Load a font (Arial or a custom font)
    try:
    ...
    vchour = round(vcmin/60,2)
    camhour = round(cammin/60,2)
    streamhour = round(streamin/60,2)


    text1, text2, text3 = str(vchour), str(camhour), str(streamhour)
    subtext = "HOURS"
